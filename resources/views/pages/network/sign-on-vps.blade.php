<x-layouts::app title="Sign-On VPS">
    <div class="px-4 sm:px-6 lg:px-8 py-8">
        <div class="max-w-7xl mx-auto">
            <flux:heading size="xl" class="mb-6">Sign-On VPS</flux:heading>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div class="p-6 rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm">
                        ...
                        <div class="space-y-3">
                            <flux:button variant="primary" class="w-full" icon="server">
                                Sign-On VPS
                            </flux:button>
                            
                            <flux:text class="text-sm text-zinc-600 dark:text-zinc-400">
                                Establish session with Kiosbank API
                            </flux:text>
                        </div>
                    </div>
