<div>
    @if(!$hasRun && !$isRunning)
        <div class="flex flex-col items-center justify-center py-12">
            ...
            <p class="text-zinc-500 mb-6">Verify your system environment configuration.</p>
            <flux:button wire:click="runCheck" variant="primary" icon="play" icon-variant="mini">
                Start Verification
            </flux:button>
        </div>
    @endif
    ...
    <div wire:loading wire:target="runCheck" class="w-full">
         <div class="p-6 rounded-xl bg-zinc-950 border border-zinc-800 shadow-lg font-mono text-sm">
            <div class="flex items-center gap-2 text-green-400">
                <span class="animate-pulse">> Verifying environment variables...</span>
            </div>
        </div>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="p-6 rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <flux:button variant="ghost" wire:click="runCheck" icon="arrow-path">
                        Refresh
                    </flux:button>
                </div>
            </div>
